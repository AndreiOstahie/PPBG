...
void Lab7::Init()
{
    ...
    LoadShader("MixShader");
    LoadShader("EarthShader");
    LoadShader("TerrainShader");
}
...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["EarthShader"], modelMatrix, mapTextures["earth"]);
    }

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["MixShader"], modelMatrix, mapTextures["crate"], mapTextures["striped"]);
    }
...

    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["TerrainShader"], modelMatrix, mapTextures["ground"], mapTextures["noise"]);
    }
}
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, Texture2D* texture1, Texture2D* texture2)
{
